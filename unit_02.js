...
function t15() {
  ...
  t15 = i15.style.border = "4px solid red";
}
...
function t17() {
  let c = document.querySelector(".i-17").value;
  document.querySelector(".out-17-1").innerHTML = +c;
  document.querySelector(".out-17-2").innerHTML = parseInt(c, 10);
  document.querySelector(".out-17-3").innerHTML = Number(c);
}
...
function t19() {
  ...
  let i192 = document.querySelector(".i-19-2").value;
